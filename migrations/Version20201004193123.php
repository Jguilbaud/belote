 ...
 */
final class Version20201004193123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, hash VARCHAR(10) NOT NULL, date INTEGER NOT NULL, name_north VARCHAR(30) NOT NULL, name_south VARCHAR(30) NOT NULL, name_west VARCHAR(30) NOT NULL, name_east VARCHAR(30) NOT NULL, total_points_ns INTEGER NOT NULL, total_points_we INTEGER NOT NULL, cards_deck CLOB DEFAULT NULL, id_current_round INTEGER NOT NULL, step VARCHAR(30) NOT NULL, current_player VARCHAR(1) NOT NULL)');
